...
urlpatterns = [
    ...
    url(r'profile/(?P<pk>\d+)/$', views.profile, name='visit_profile'),
    url(r'^profile/edit/$', views.edit_profile, name='edit_profile'),
    url(r'^messages/(?P<pk>\d+)/$', views.messages, name='messages'),

    url(r'connect/(?P<operation>.+)/(?P<pk>\d+)/$', views.friendship, name='friendship'),
]
